...
import { LastFmData, LastFmFeaturedTrack } from "../../../types/plugins/lastFmTypes";
...
import TerminalDots from "../_components/Terminal/Terminal_Dots";
import TerminalLineBreak from "../_components/Terminal/Terminal_LineBreak";
import TerminalLineWithDots from "../_components/Terminal/Terminal_LineWithDots";
...
function LastFMStatistics({ statsData }: { statsData: LastFmData }): JSX.Element {
  ...
  const title = pluginLastfm.recent_tracks_title;
