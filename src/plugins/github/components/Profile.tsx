...
const DefaultProfile = ({ userData }: { userData: UserData }) => {
  ...
  const allMetrics = [
    ...
    { icon: <FaDonate className="color-primary" />, title: "Sponsorships", value: userData.sponsorshipsAsMaintainer.totalCount + userData.sponsorshipsAsSponsor.totalCount },
    { icon: <FaStar className="default-completed" />, title: "Starred Repos", value: userData.starredRepositories?.totalCount || 0 },
    { icon: <FaAward className="color-primary" />, title: "Achievements", value: 0 }, // Placeholder para futuras conquistas
